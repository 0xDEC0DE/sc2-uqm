...
ValidateOrbit (PLANET_DESC *planet, int sizeNumer, int dyNumer, int denom)
{
	...
	else if (planet->data_index == PKUNK_STARBASE)
	{
		planet->image.frame = SetAbsFrameIndex (SpaceJunkFrame, 25);
	}
	else if (planet->data_index == DRUUGE_STARBASE)
	{
		planet->image.frame = SetAbsFrameIndex (SpaceJunkFrame, 26);
	}
	else if (planet->data_index == UTWIG_STARBASE)
	{
