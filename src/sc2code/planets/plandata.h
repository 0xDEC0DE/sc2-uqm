...
enum
{
	...
	UTWIG_STARBASE     = HIERARCHY_STARBASE,
	SUPOX_STARBASE     = UTWIG_STARBASE,
	DRUUGE_STARBASE    = HIERARCHY_STARBASE,
	ORZ_STARBASE       = HIERARCHY_STARBASE,
	PKUNK_STARBASE     = HIERARCHY_STARBASE,
	ZOQFOTPIK_STARBASE = HIERARCHY_STARBASE,
